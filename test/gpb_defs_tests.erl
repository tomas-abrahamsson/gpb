...
parses_msg_with_custom_option_test() ->
    ...
    [{file, _},
     ...
     {{enum_containment,"x"}, []},
     {{ext_origin, 'google.protobuf.FieldOptions'},
      {x, [#?gpb_field{name=my_f_option}]}},
     {{ext_origin, 'google.protobuf.MessageOptions'},
      {x, [#?gpb_field{name=my_m_option}]}},
...
parses_extending_msgs_test() ->
    ...
    [{file, _},
     {proto_defs_version, _},
     {{enum_containment, _}, _},
     {{ext_origin,m1},{'.', [#?gpb_field{name=f2}]}},
...
parses_extend_scope_rules_test() ->
    ...
    [{file, _},
     {proto_defs_version, _},
     {{enum_containment, _}, _},
     {{ext_origin,'m1.m1'},   {'.', [#?gpb_field{name=e22}]}},
     {{ext_origin,'m1.m1'},   {m1,  [#?gpb_field{name=e21}]}},
     {{ext_origin,'m1.m1.m1'},{'m1.m1.m1', [#?gpb_field{name=e31}]}},
...
parses_nested_extending_msgs_in_package_test() ->
    ...
    [{file, _},
     ...
     {proto_defs_version, _},
     {{enum_containment, _}, _},
     {{ext_origin,'p1.p2.m1'},{'p1.p2.m1', [#?gpb_field{}]}},
...
extend_msg_several_times_test() ->
    ...
    [{file, _},
     ...
     {{enum_containment, _}, _},
     {{ext_origin,m1},{'.', [#?gpb_field{name=f2}]}},
     {{ext_origin,m1},{'.', [#?gpb_field{name=f3}]}},
     {{extensions,m1},[{200,299}]},
     {{msg,m1},
...
extend_msg_in_other_package_test() ->
    ...
    [{file, _},
     ...
     {{ext_origin, 'foo.fm1'}, {bar, [#?gpb_field{},
                                      #?gpb_field{type={msg,'foo.fm2'}}]}},
...
extending_and_resolving_ref_to_msg_in_enclosing_package_test() ->
    ...
    [{file, _},
     ...
     {{ext_origin, 'p.x.a'}, {'p.x.a', [#?gpb_field{}]}},
...
scope_when_resolving_extend_field_refs_test() ->
    ...
    [{file, _},
     ...
     {{ext_origin, 'a.Foo'}, {b, [#?gpb_field{name=b, fnum=200}]}},
...
proto_defs_versions_test() ->
    ...
    AllDefs = parse_several_file_lines(Fs, []),
    [{proto_defs_version, _} | Rest] = AllDefs,

    %% Try converting an unhandled version
...
is_io_list(X) when is_list(X); is_binary(X) ->
    try
        iolist_to_binary(X),
        true
    catch error:badarg ->
